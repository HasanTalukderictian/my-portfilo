...
const reviews = [
    { image: 'https://i.ibb.co.com/Cp1CbgfC/client1.jpg', name: 'Mamun Hasan', text: 'Excellent work! Truly exceeded my expectations. Will definitely work again.', tag: 'Fashion' },
    { image: 'https://i.ibb.co.com/KcxRPqDc/client2.jpg', name: 'Sharif Ahmed', text: 'Really pleased with your work. Very professional approach and timely delivery.', tag: 'Accessories' },
    { image: 'https://i.ibb.co.com/7tc7Pfb8/client3.jpg', name: 'Faruk Ahmed', text: 'Quick and smart design! Delivered before the deadline. Highly recommended.', tag: 'Fashion' },
    { image: 'https://i.ibb.co.com/Q7q8dcBG/client4.jpg', name: 'Rafiq Khan', text: 'Thanks for the best output. Creative and innovative design solutions.', tag: 'Luxury' },
    { image: 'https://i.ibb.co.com/nMh3YdBj/client5.jpg', name: 'Raju Ahamed', text: 'Keep doing good work. One of the best experiences I\'ve had.', tag: 'Luxury' },
    { image: 'https://i.ibb.co.com/39S0Yz8T/client6.jpg', name: 'Habib Mirza', text: 'Amazing experience working with you. Very talented and creative.', tag: 'Luxury' },
];
    ...
    return (
        <section id={id} className="bg-slate-50 px-5 py-20">
            <div className="mx-auto max-w-6xl">
                <SectionTitle title="What clients say" subtitle="Kind words from people I've worked with." />

                <div className="columns-1 gap-6 md:columns-2 lg:columns-3">
                    {reviews.map((r) => (
                        <figure key={r.name} className="mb-6 break-inside-avoid rounded-2xl bg-white p-6 ring-1 ring-slate-200">
                            ...
                            <figcaption className="mt-5 flex items-center gap-3">
                                <img src={r.image} alt={r.name} loading="lazy" className="h-11 w-11 rounded-full object-cover" />
                                <div>
                                    <p className="font-semibold text-slate-900">{r.name}</p>
                                    <p className="text-sm text-slate-500">{r.tag}</p>
                                </div>
                            </figcaption>
                        </figure>
                    ))}
