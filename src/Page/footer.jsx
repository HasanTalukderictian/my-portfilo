...
const Footer = () => {
    ...
    return (
        <footer className="bg-slate-900 px-5 py-12 text-slate-300">
            <div className="mx-auto max-w-6xl">
                <div className="flex flex-col items-center justify-between gap-8 border-b border-slate-700 pb-8 md:flex-row">
                    <div className="text-center md:text-left">
                        <p className="font-display text-2xl font-bold text-white">Hasan Talukder</p>
                    ...
                    <ul className="flex flex-wrap justify-center gap-x-6 gap-y-2">
                        {navLinks.slice(1).map((l) => (
                            <li key={l.href}>
                                <a href={l.href} className="transition-colors hover:text-white">{l.name}</a>
                            </li>
                        ))}
                    </ul>
                    ...
                    <div className="flex gap-3">
                        {socials.map((s) => (
                            <a
                                ...
                                rel="noopener noreferrer"
                                aria-label={s.name}
                                className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-800 transition-colors hover:bg-teal-700 hover:text-white"
                            >
                ...
                <p className="pt-6 text-center text-sm text-slate-400 md:text-left">
                    © {year} Hasan Talukder. All rights reserved.
                </p>
            </div>
        </footer>
    );
